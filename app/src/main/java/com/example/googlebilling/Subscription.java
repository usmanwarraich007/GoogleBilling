...
import com.example.googlebilling.util.IabBroadcastReceiver;
import com.example.googlebilling.util.IabHelper;
import com.example.googlebilling.util.IabResult;
import com.example.googlebilling.util.Inventory;
import com.example.googlebilling.util.Purchase;

import java.util.ArrayList;
import java.util.List;

import static com.example.googlebilling.Constants.SKU_DELAROY_MONTHLY;
import static com.example.googlebilling.Constants.SKU_DELAROY_SIXMONTH;
import static com.example.googlebilling.Constants.SKU_DELAROY_THREEMONTH;
import static com.example.googlebilling.Constants.SKU_DELAROY_YEARLY;
import static com.example.googlebilling.Constants.base64EncodedPublicKey;
...
public class Subscription extends AppCompatActivity implements IabBroadcastReceiver.IabBroadcastListener,
    ...
    public void updateUi() {
       ...
       Button subscribeButton = (Button) findViewById(R.id.sub_btn);
        if (mSubscribedToDelaroy) {
            Toast.makeText(this, "Eat my toast", Toast.LENGTH_SHORT).show();
        } else {
